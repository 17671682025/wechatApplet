...
let interfaceCanvasRouter = [
	...
	{ routerName: 'CanvasContext.arc', routerPath: `${interfacePath}canvas/CanvasContext.arc/index` },
	{ routerName: 'CanvasContext.arcTo', routerPath: `${interfacePath}canvas/CanvasContext.arcTo/index` },
	{ routerName: 'CanvasContext.beginPath', routerPath: `${interfacePath}canvas/CanvasContext.beginPath/index` },
	{ routerName: 'CanvasContext.bezierCurveTo', routerPath: `${interfacePath}canvas/CanvasContext.bezierCurveTo/index` },
	{ routerName: 'CanvasContext.clearRect', routerPath: `${interfacePath}canvas/CanvasContext.clearRect/index` },
	{ routerName: 'CanvasContext.clip', routerPath: `${interfacePath}canvas/CanvasContext.clip/index` },
	{ routerName: 'CanvasContext.closePath', routerPath: `${interfacePath}canvas/CanvasContext.closePath/index` },
	{ routerName: 'CanvasContext.createCircularGradient', routerPath: `${interfacePath}canvas/CanvasContext.createCircularGradient/index` },
	{ routerName: 'CanvasContext.createLinearGradient', routerPath: `${interfacePath}canvas/CanvasContext.createLinearGradient/index` },
	{ routerName: 'CanvasContext.createPattern', routerPath: `${interfacePath}canvas/CanvasContext.createPattern/index` },
	{ routerName: 'CanvasContext.draw', routerPath: `${interfacePath}canvas/CanvasContext.draw/index` },
	{ routerName: 'CanvasContext.drawImage', routerPath: `${interfacePath}canvas/CanvasContext.drawImage/index` },
	{ routerName: 'CanvasContext.fill', routerPath: `${interfacePath}canvas/CanvasContext.fill/index` },
	{ routerName: 'CanvasContext.fillRect', routerPath: `${interfacePath}canvas/CanvasContext.fillRect/index` },
	...
	{ routerName: 'CanvasContext.save', routerPath: `${interfacePath}canvas/CanvasContext.save/index` },
	{ routerName: 'CanvasContext.scale', routerPath: `${interfacePath}canvas/CanvasContext.scale/index` },
	{ routerName: 'CanvasContext.setFillStyle', routerPath: `${interfacePath}canvas/CanvasContext.setFillStyle/index` },
	{ routerName: 'CanvasContext.setFontSize', routerPath: `${interfacePath}canvas/CanvasContext.setFontSize/index` },
	{ routerName: 'CanvasContext.setGlobalAlpha', routerPath: `${interfacePath}canvas/CanvasContext.setGlobalAlpha/index` },
	{ routerName: 'CanvasContext.setLineCap', routerPath: `${interfacePath}canvas/CanvasContext.setLineCap/index` },
	{ routerName: 'CanvasContext.setLineDash', routerPath: `${interfacePath}canvas/CanvasContext.setLineDash/index` },
	{ routerName: 'CanvasContext.setLineJoin', routerPath: `${interfacePath}canvas/CanvasContext.setLineJoin/index` },
	{ routerName: 'CanvasContext.setLineWidth', routerPath: `${interfacePath}canvas/CanvasContext.setLineWidth/index` },
	{ routerName: 'CanvasContext.setMiterLimit', routerPath: `${interfacePath}canvas/CanvasContext.setMiterLimit/index` },
	{ routerName: 'CanvasContext.setShadow', routerPath: `${interfacePath}canvas/CanvasContext.setShadow/index` },
	{ routerName: 'CanvasContext.setStrokeStyle', routerPath: `${interfacePath}canvas/CanvasContext.setStrokeStyle/index` },
	{ routerName: 'CanvasContext.setTextAlign', routerPath: `${interfacePath}canvas/CanvasContext.setTextAlign/index` },
	{ routerName: 'CanvasContext.setTextBaseline', routerPath: `${interfacePath}canvas/CanvasContext.setTextBaseline/index` },
	{ routerName: 'CanvasContext.setTransform', routerPath: `${interfacePath}canvas/CanvasContext.setTransform/index` },
	{ routerName: 'CanvasContext.strokeRect', routerPath: `${interfacePath}canvas/CanvasContext.strokeRect/index` },
	{ routerName: 'CanvasContext.strokeText', routerPath: `${interfacePath}canvas/CanvasContext.strokeText/index` },
	{ routerName: 'CanvasContext.transform', routerPath: `${interfacePath}canvas/CanvasContext.transform/index` },
	{ routerName: 'CanvasContext.translate', routerPath: `${interfacePath}canvas/CanvasContext.translate/index` },
